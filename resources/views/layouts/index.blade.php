        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($absensi as $data)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $data->nama_karyawan }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $data->clock_in }} - {{ $data->clock_out }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $data->overtime ?? 'Tidak ada' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $data->picture ?? 'Tidak ada' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $data->location ?? 'Tidak ada' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $data->notes ?? 'Tidak ada' }}</td>
