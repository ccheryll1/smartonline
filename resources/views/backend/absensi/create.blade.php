    ...
    <form action="{{ route('absensi.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="mb-4">
                ...
                <input type="time" name="overtime" id="overtime" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring">
            </div>
        </div>
        <div class="mb-4">
