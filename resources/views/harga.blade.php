    ...
    <div class="container mx-auto max-w-6xl px-3">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-7">
            ...
            <div class="text-white space-y-6 mt-7">
                <h1 class="text-4xl md:text-[40px] font-semibold leading-tight">
            ...
            <!-- Form -->
            <div class="bg-white rounded-3xl mx-30 w-110 p-10 py-25 space-y-5">
                <input type="email" placeholder="Work Email*" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                <div class="grid grid-cols-2 gap-4">
                    <input type="text" placeholder="First name*" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                    <input type="text" placeholder="Last name*" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <select class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                        <option value="Indonesia">Indonesia</option>
                    </select>
                    <input type="text" placeholder="+62" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <input type="text" placeholder="Company name*" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                    <input type="number" placeholder="Number of Employees*" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none">
                </div>
                <button class="w-full bg-blue-900 text-white text-sm font-semibold p-2 rounded-2xl hover:bg-blue-700 transition-all">
                    REQUEST A DEMO
                </button>
            </div>
        </div>
